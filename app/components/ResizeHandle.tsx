...
export default function ResizeHandle() {
  ...
  return (
    <div 
      ...
      className="absolute bottom-0 right-0 w-5 h-5 cursor-nwse-resize z-[100] flex items-end justify-end p-1 text-white/20 hover:text-white/60 transition-colors"
